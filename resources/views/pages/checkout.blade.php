                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="{{ route('checkout-remove', $detail->id) }}">
                                                    <img src="{{ url('frontend/images/ic_remove 1.png') }}">
                                                </a>
                                            </td>
                                        </tr>
                                     @empty
                             ...
                             <form class="form-inline" method="POST" action="{{ route('checkout-create', $item->id) }}">
                                @csrf
                                 ...
                                 <div class="input-group mb-2 mr-sm-2">
                                     <input type="text" name="doe_passport" class="datepicker form-control" id="doe_passport" style="width:150px" placeholder="DOE Passport">
                                 </div>
...
<script>
    $(document).ready(function() {
        $('.datepicker').datepicker({
            ...
            icons: {
                rightIcon: '<img src="{{ url('frontend/images/ic_doe 1.png') }}" />'
            }
        });
    });
</script>
